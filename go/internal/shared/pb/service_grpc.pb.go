...
const (
	FogistrationService_Stream_FullMethodName = "/fogistration.v1.FogistrationService/Stream"
)

// FogistrationServiceClient is the client API for FogistrationService service.
//
...
func NewFogistrationServiceClient(cc grpc.ClientConnInterface) FogistrationServiceClient {
...
// UnimplementedFogistrationServiceServer must be embedded to have
...
func (UnimplementedFogistrationServiceServer) testEmbeddedByValue()                             {}

// UnsafeFogistrationServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to FogistrationServiceServer will
// result in compilation errors.
type UnsafeFogistrationServiceServer interface {
	mustEmbedUnimplementedFogistrationServiceServer()
}

func RegisterFogistrationServiceServer(s grpc.ServiceRegistrar, srv FogistrationServiceServer) {
	// If the following call pancis, it indicates UnimplementedFogistrationServiceServer was
	...
	s.RegisterService(&FogistrationService_ServiceDesc, srv)
}
...
var FogistrationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fogistration.v1.FogistrationService",
	HandlerType: (*FogistrationServiceServer)(nil),
